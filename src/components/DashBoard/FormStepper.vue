    ...
    <v-stepper v-if="showStepper" hide-actions mobile v-model="step" :items="etapas">
        <template v-slot:item.1>
            <form @submit.prevent="avancarEtapa">
                ...
                <v-card-actions>
                    <v-btn text="Anterior" disabled />
                    <v-spacer />
                    <v-btn type="avancarEtapa" text="Proximo" />
        ...
        <template v-slot:item.2>
            ...
            <form @submit.prevent="avancarEtapa">
                ...
                <v-checkbox-group model="resideCom" required>

                    <v-checkbox value="Pais" label="Com seus pais" />
                    <v-checkbox value="Mãe" label="Com sua mãe" />
                    <v-checkbox value="Pai" label="Com seu pai" />
                    <v-checkbox value="Irmãos" label="Com seus irmãos" />
                    <v-checkbox value="Irmã" label="Com sua irmã" />
                    <v-checkbox value="Irmão" label="Com seu irmão" />
                    <v-checkbox value="Avós/Avô/Avó" label="Com seus avós/avô/avó" />
                    <v-checkbox value="Familiares" label="Com familiares" />
                    <v-checkbox value="Sozinho" label="Sozinho" />
                    <v-checkbox value="Amigos" label="Com amigos" />
                    <v-checkbox value="Colegas estudantes" label="Com colegas estudantes" />
                    <v-checkbox value="Alojamento" label="No alojamento" />
                    <v-checkbox value="República" label="Em uma república" />
                    <v-checkbox value="Outros" label="Outros" />
                ...
                <v-card-actions>
                    <v-btn text="Anterior" @click="voltarEtapa" />
                    <v-spacer />
                    <v-btn type="avancarEtapa" text="Proximo" />
        ...
        <template v-slot:item.4>
            <form @submit.prevent="submit">
                ...
                <v-card-actions>
                    <v-btn text="Anterior" @click="voltarEtapa" />
                    <v-spacer />
                    <v-btn @click="enviarRespostas" text="Enviar respostas " />
...
import mensagemConcluido from '@/components/DashBoard/formPsi/mensagemConcluido.vue'

const radioGroupRule = ref([
    v => !!v || 'Campo Obrigatório'
])

const rulesRadioGroup = ref([
    v => !!v || 'Campo obrigatório'
...
const showMensagemConcluido = ref(true)

function enviarRespostas() {
    const respostas = `{ "Estudante de": "${estudanteNivel.value}",
    ...
    console.log(JSON.parse(respostas))

    // console.log('Formulário enviado com sucesso!', JSON.stringify(respostas));
